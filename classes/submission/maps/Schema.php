...
class Schema extends \PKP\submission\maps\Schema
{
        ...
        foreach ($props as $prop) {
            switch ($prop) {
                ...
                case 'reviewersNotAssigned':
                    ...
                    $output[$prop] = $currentReviewRound && $this->reviewAssignments && $reviewAssignments->count() < $required;
                    break;
                case 'reviewRounds':
    ...
    protected function getAvailableEditorialDecisions(int $stageId, Submission $submission): array
    {
        ...
        $reviewRound = ReviewRound::getLastBySubmissionId($submission->getId(), $stageId);
